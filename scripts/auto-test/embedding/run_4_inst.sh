...
CONFIGS=(
	config_fix_token_len/4insts/config_fix_token_len.json
	config_fix_token_len/4insts/config_fix_token_len2.json
	config_fix_token_len/4insts/config_fix_token_len3.json
	config_fix_token_len/4insts/config_fix_token_len4.json
)
